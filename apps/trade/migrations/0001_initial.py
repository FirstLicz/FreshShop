# Generated by Django 2.0.3 on 2018-03-28 09:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_SUCCESS', '成功'), ('TRADE_CLOSED', '超时关闭'), ('WAIT_BUYER_PAY', '交易创建'), ('TRADE_FINISHED', '交易结束'), ('paying', '待支付')], default='paying', max_length=30, verbose_name='交易状态')),
                ('post_message', models.CharField(blank=True, max_length=100, null=True, verbose_name='订单留言')),
                ...
                ('address', models.CharField(default='', max_length=200, verbose_name='订单地址')),
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trade.OrderInfo', verbose_name='订单详情'),
        ),
    ]
